package com.ivs.tws.Map.Model;



public class GlobalCfg {

    public final static int VIEWP_W = 1400;
    public final static int VIEWP_H = 800;
    ...
    public final static int TILE_DEPTH = 16;
    public int MAX_MUX_TILE_W = 100;
    public int MAX_NUM_TILE_H = 100;
